...
class Position(DictStringify):
    def __init__(self, x: float, y: float, z: float, timestamp: float, pos_type: int, raw_p: []):
        self._x = x
        self._y = y
        self._z = z
...
class PositionVelocityAlarm(DictStringify):
    def __init__(self,
                 x: float,
                 y: float,
                 z: float,
        ...
        self._vy = vy
        self._vz = vz
        self._overspeed_alarm = overspeed_alarm
        self._raw_p = raw_p
    ...
    @property
    def overspeed_alarm(self):
        return self._overspeed_alarm
...
class PositionVelocity(DictStringify):
    def __init__(self,
                 x: float,
                 y: float,
                 z: float,
...
class IMUValue(SensorValue):
    ...
    #              mag_x: float, mag_y: float, mag_z: float, roll: float, pitch: float, yaw: float, accl_x: float,
    #              accl_y: float, accl_z: float):
        # self.acc_x = acc_x
        # self.acc_y = acc_y
        # self.acc_z = acc_z
        # self.gyro_x = gyro_x
