            ...
            <div class="jarviswidget jarviswidget-color-blueDark"
				...
				<div>
					<div class="widget-body no-padding">
						<form id="newsensor-form" class="smart-form">
							...
							<fieldset>
                                <section>
                                    ...
                                    <label class="input state-success"> <i class="icon-prepend fa fa-barcode"></i>
                                        <input type="text" name="sensor" <?php if ($sensor_ble_mac != 'sensor') {
                                            echo "value=\"$sensor_ble_mac\" readonly=\"readonly\"";
                                        }?>>
                                    </label>
                                </section>
                                <section>
...
<script type="text/javascript">
	...
	$('#newsensor-form').submit(function(e){
		$.post("<?=base_url('register/add_sensor')?>", $( "#newsensor-form" ).serialize()).done(function(data) {
            if(data == '0'){
                alert('please fill ');
            }else{
