            ...
            .each(function () {
                ...
                if (sparklineType == 'line') {
                    ...
                    var sparklineHeight = $this.data('sparkline-height') || '20px',
                        ...
                        thisLineColor = $this.data('sparkline-line-color') || $this.css('color') ||
                            '#0000f0',
                ...
                if (sparklineType == 'bullet') {
                    ...
                    var thisBulletHeight = $this.data('sparkline-height') || 'auto',
                        ...
                        thisBulletPerformanceColor = $this.data('sparkline-performance-color') ||
                            '#3030f0',
                ...
                if (sparklineType == 'compositeline') {
                    ...
                    var sparklineHeight = $this.data('sparkline-height') || '20px',
                        ...
                        thisMinSpotColor2 = $this.data('sparkline-minspot-color-bottom') ||
                            thisMinSpotColor1,
                        thisMaxSpotColor2 = $this.data('sparkline-maxspot-color-bottom') ||
                            thisMaxSpotColor1,
                        thishighlightSpotColor1 = $this.data('sparkline-highlightspot-color-top') ||
                            '#50f050',
                        thisHighlightLineColor1 = $this.data('sparkline-highlightline-color-top') ||
                            '#f02020',
